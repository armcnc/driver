...
static int32_t hal_init(const char *component_name, int32_t component_id)
{
    int port, retval;
    ...
    {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() in_pins failed \n");
        return -1;
    }

    if (out_pins == NULL || out_pins[0] == '\0')
    {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() out_pins failed \n");
        return -1;
    }

    if (pwm_types == NULL || pwm_types[0] == '\0')
    {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_types failed \n");
        return -1;
    }
    ...
    if (!gpio_hal_in || !gpio_hal_in_not || !gpio_hal_out || !gpio_hal_out_not || !gpio_hal_pull || !gpio_hal_drive) {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal failed \n");
        return -1;
    }
    ...
    for (int in_pins_i = 0; in_pins_i < in_pins_count; in_pins_i++)
    {
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_in failed \n");
            return -1;
        }
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_in_not failed \n");
            return -1;
        }
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_pull failed \n");
            return -1;
        }
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_drive failed \n");
            return -1;
        }
    ...
    for (int out_pins_i = 0; out_pins_i < out_pins_count; out_pins_i++)
    {
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_out failed \n");
            return -1;
        }
        ...
        if (retval < 0) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_hal_out_not failed \n");
            return -1;
        }
    ...
    if (pwm_types_count > 0)
    {
        ...
        if (!pwm_hal) {
            rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal failed \n");
            return -1;
        }
        ...
        for (int pwm_types_i = 0; pwm_types_i < pwm_types_count; pwm_types_i++)
        {
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal enable failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].enable = 0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pwm_port failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pwm_port = UINT32_MAX;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pwm_pin failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pwm_pin = UINT32_MAX;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pwm_invert failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pwm_invert = 0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dir_port failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dir_port = UINT32_MAX;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dir_pin failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dir_pin = UINT32_MAX;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dir_invert failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dir_invert = 0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dir_hold failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dir_hold = 50000;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dir_setup failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dir_setup = 50000;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_cmd failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_cmd = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_min failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_min = -1.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_max failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_max = 1.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_max_t failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_max_t = 0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_offset failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_offset = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_scale failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_scale = 1.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pos_scale failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pos_scale = 1.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pos_cmd failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pos_cmd = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal vel_scale failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].vel_scale = 1.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal vel_cmd failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].vel_cmd = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal freq_cmd failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].freq_cmd = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal freq_min failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].freq_min = 50.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal freq_max failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].freq_max = 500000.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal dc_fb failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].dc_fb = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal pos_fb failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].pos_fb = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal freq_fb failed \n");
                return -1;
            }
            *pwm_hal[pwm_types_i].freq_fb = 0.0;
            ...
            if (retval < 0) {
                rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_hal vel_fb failed \n");
                return -1;
            }
    ...
    if (retval < 0) {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_write failed \n");
        return -1;
    }
    ...
    if (retval < 0) {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() gpio_read failed \n");
        return -1;
    }
    ...
    if (retval < 0) {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_write failed \n");
        return -1;
    }
    ...
    if (retval < 0) {
        rtapi_print_msg(RTAPI_MSG_ERR, "[errot]: hal_init() pwm_read failed \n");
        return -1;
    }
...
int rtapi_app_main(void)
{
    ...
    if (hal_init(component_name, component_id)) {
